...
function App() {
  ...
  const fetchMessages_BetweenBothUsers = async (givenCombinedID: string) => {
    ...
    // TODO SORT-BY-DATE
    const q = query(collection(db, "_Chats"), where("combinedID", "==", givenCombinedID));  // * Filtering Docs
  ...
  return (<>
    <AuthContext.Provider value={{ User, setUser, showAlert, setShowAlert, fetchMessages_BetweenBothUsers }}>
